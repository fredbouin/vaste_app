// client/src/services/calculationService.js

/**
 * Client-side calculation service that mirrors the server-side logic
 * This ensures consistent calculation between frontend and backend
 */
 ...
 */
export const calculateWoodCost = (woodEntries, settings) => {
 ...
 */
export const calculateOverheadRate = (overhead) => {
 ...
 */
export const calculateHardwareCost = (hardware) => {
 ...
 */
export const calculateUpholsteryCost = (upholstery) => {
 ...
 */
export const calculateComponentsCost = (components) => {
 ...
 */
export const calculatePricing = (itemData, settings) => {
