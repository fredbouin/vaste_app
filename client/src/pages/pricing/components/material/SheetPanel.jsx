...
const SheetPanel = ({ sheetMaterials = [], onChange }) => {
  ...
  const calculateTotalMaterialsCost = () => {
    return sheetMaterials.reduce((sum, material) => {
      if (!material.pricePerSheet || !material.piecesPerSheet) return sum;
...
// // src/pages/pricing/components/SheetPanel.jsx
// import React, { useState, useEffect } from 'react';
// import { Plus, Minus } from 'lucide-react';
...
//   // Load available sheet materials from settings
//   useEffect(() => {
//     const savedSettings = localStorage.getItem('calculatorSettings');
//     if (savedSettings) {
//       const settings = JSON.parse(savedSettings);
...
//     // If selecting a new sheet, load its details
//     if (field === 'sheetId') {
//       const selectedSheet = availableSheets.find(s => s.id === Number(value));
//       if (selectedSheet) {
//         newMaterials[index] = {
...
//   const calculateCostPerPiece = (material) => {
//     if (!material.piecesPerSheet || !material.pricePerSheet || !material.numSheets) {
//       return 0;
//     }
//     const totalCost = Number(material.pricePerSheet) * Number(material.numSheets);
//     const totalPieces = Number(material.piecesPerSheet) * Number(material.numSheets);
//     return totalCost / totalPieces;
//   };

//   const calculateTotalCost = (material) => {
//     if (!material.pricePerSheet || !material.numSheets) {
//       return 0;
//     }
//     return Number(material.pricePerSheet) * Number(material.numSheets);
//   };
...
//             </label>
//             <div className="mt-1 p-2 bg-gray-100 rounded-md text-sm">
//               <div>${calculateTotalCost(material).toFixed(2)} total</div>
//               <div className="text-gray-500">
//                 ${calculateCostPerPiece(material).toFixed(2)}/piece
//               </div>
//             </div>
...
//       {/* Total Sheet Materials Cost */}
//       {sheetMaterials.length > 0 && (
//         <div className="mt-4 p-4 bg-gray-100 rounded-md">
//           <div className="flex justify-between">
//             <span className="font-medium">Total Sheet Materials Cost:</span>
//             <span>
//               ${sheetMaterials.reduce((sum, material) => sum + calculateTotalCost(material), 0).toFixed(2)}
//             </span>
//           </div>
//         </div>
//       )}
