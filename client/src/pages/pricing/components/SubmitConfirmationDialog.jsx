...
const ConfirmationDialog = ({ 
  ...
  const variationExists = data.variation && existingVariations.includes(data.variation);
              ...
              <div className="bg-gray-50 p-4 rounded-md">
                ...
                <div className="space-y-1">
                  {components.map((component, index) => (
                    <div key={component._id || component.id || `component-${index}`} className="flex justify-between text-sm">
                      <div>
                        <span>{component.componentName || component.name || 'Unnamed'}</span>
...
//                 <div className="space-y-1">
//                   {components.map((component, index) => (
//                     <div key={component._id || component.id || index} className="flex justify-between text-sm">
//                       <div>
